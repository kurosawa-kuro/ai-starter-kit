...
### Phase 2: AI 環境の自動セットアップ

このリポジトリを WSL に `git clone` して、`src/scripts/setup-*.sh` を実行する。
...
| ファイル | 役割 |
|---|---|
| [`AIによる事務処理・プログラミング自動化_環境構築ガイド.md`](./AIによる事務処理・プログラミング自動化_環境構築ガイド.md) | Phase 1 の WSL + VSCode + Git 手動セットアップ手順書 |
